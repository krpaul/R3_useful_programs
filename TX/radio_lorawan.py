...
devaddr = bytearray([ 0x26, 0x02, 0x19, 0x2E ])
# TTN Network Key, 16 Bytes, MSB
nwkey = bytearray([ 0x76, 0xB0, 0xF9, 0x7B, 0x87, 0x51, 0xDC, 0xB6, 0x1A, 0x0B, 0x11, 0x13, 0xEC, 0x45, 0x80, 0x5F ])
# TTN Application Key, 16 Bytess, MSB
app = bytearray([ 0x3A, 0x19, 0x21, 0xC9, 0x63, 0xEB, 0x69, 0x8A, 0x2D, 0x3A, 0xC6, 0x6C, 0x81, 0x5E, 0x42, 0xE7 ])
